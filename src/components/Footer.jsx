  ...
  return (
    <footer className="bg-foreground text-background font-body">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="border-t border-background/15 mt-12 pt-6 flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between">
          <p className="text-xs text-background/55">© {new Date().getFullYear()} LATIELLE MARKET HUB. All rights reserved.</p>
