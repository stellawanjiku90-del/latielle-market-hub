...
- Offline app shell and cached public listing browsing
...
## Before going live
1. Set the real PostgreSQL connection URL.
...
7. Run `npm run lint` and `npm run build` before deployment.
8. Test registration, login, listing creation, buyer requests, M-Pesa success/failure/retry, support email and the public chat.
